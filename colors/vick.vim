...
:hi Search guibg=peru guifg=wheat cterm=none ctermfg=white ctermbg=blue
...
:hi Underlined cterm=underline ctermfg=lightgray
:hi Error guifg=White guibg=Red cterm=bold ctermfg=7 ctermbg=1
:hi SpellErrors guifg=White guibg=Red cterm=bold ctermfg=7 ctermbg=1

" for miniBufExplore plugin
" :hi MBENormal  guibg=darkblue ctermbg=darkblue ctermbg=white
" :hi MBEChanged guibg=darkblue ctermbg=darkblue ctermbg=red
:hi MBEVisibleNormal  guibg=darkblue ctermbg=yellow ctermfg=red
